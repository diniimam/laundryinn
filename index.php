...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['login'])) {
    // Simulasi proses login (ganti dengan koneksi database sesungguhnya)
    ...
    if ($input_username === $valid_username && $input_password === $valid_password) {
        ...
        $_SESSION['nama_user'] = $input_username;
...
<body class="gradient-bg">
    <div class="container py-5">
        <!-- Konten untuk pengguna yang belum login - Form Login -->
        <div class="row justify-content-center">
            <div class="col-md-6 col-lg-4">
                <div class="card login-card shadow-lg" id="login-form">
                    <div class="card-body p-4">
                        ...
                        <form method="post" action="proses_login.php" autocomplete="off">
                            ...
                            <button type="submit" class="btn btn-primary-custom text-white w-100 py-3 mb-4">
    ...
    <script>
        // Reset form ketika halaman dimuat (hanya untuk form login)
